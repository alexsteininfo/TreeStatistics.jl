...
function main(modulenumber, modulesize, age, seed, showprogress=false)
    rng = MersenneTwister(seed)
    input = MultilevelInput(modulesize=modulesize, numclones=0, fixedmu=true, b=1, d=0,
...
function main_fast(modulenumber, modulesize, age, seed, showprogress=false)
    rng = MersenneTwister(seed)
    input = MultilevelInput(modulesize=modulesize, numclones=0, fixedmu=true, b=1, d=0,
        bdrate=1, clonalmutations=0, pop_age=age*365, branchrate=3/365, branchfraction=0.2, 
        μ=1)
